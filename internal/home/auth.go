...
func (a *Auth) findUserByName(name string) (u webUser, ok bool) {
	a.lock.Lock()
	defer a.lock.Unlock()
...
func VarifyTokenPaseto(token string) (bool, error) {
	...
	publicKeyHex := "2d5bbee56cd9c1dddd310a36fb5c3582e360904a17b1e4c7ee4b1f5b04428946"
	publicKey, publicKeyErr := paseto.NewV4AsymmetricPublicKeyFromHex(publicKeyHex)
	if publicKeyErr != nil {
